...
You represent and warrant that Your Submitted Materials do not and will not:

a) Infringe any copyright, patent, trademark, trade secret, or other intellectual property right of any third party;

b) Violate any terms of service, end-user license agreement, or other contractual obligation;

c) Contain any stolen, misappropriated, or unlawfully obtained materials, including but not limited to:
   - Proprietary model weights from closed-source models (e.g., unauthorized GPT, Claude, or PaLM derivatives)
   - Training data obtained through unauthorized scraping or data breaches
   - Materials subject to confidentiality obligations

d) Violate any applicable laws or regulations, including export control laws, data protection regulations, or AI governance requirements.

### 3.3 No Harmful Content

You represent and warrant that Your Submitted Materials do not contain:

a) **Malicious Code:** Viruses, backdoors, trojans, time bombs, or other malicious code designed to harm systems or compromise security;

b) **Illegal Content:** Content that is illegal under applicable laws, including child exploitation material, terrorist content, or content that promotes violence;

c) **Unauthorized Personal Data:** Personally identifiable information (PII) or sensitive personal data included without proper consent and legal basis;

d) **Intentional Bias:** Models intentionally designed to produce discriminatory, harmful, or biased outputs (acknowledging that unintentional bias is an industry-wide challenge).

### 3.4 Compliance with Laws

You represent and warrant that:

a) Your submission complies with all applicable data protection laws (GDPR, CCPA, etc.);

b) Your submission complies with all applicable AI/ML regulations in Your jurisdiction;

c) Your submission does not violate export control or sanctions regulations;
...
## 4. Base Model and License Disclosure

### 4.1 Disclosure Requirement

If Your Submitted Materials are based on, derived from, fine-tuned from, or otherwise incorporate any Base Model or third-party dataset, You **must** disclose:

a) The name and version of the Base Model (e.g., "Llama 2 7B", "Mistral 7B v0.1");

b) The license under which the Base Model is distributed (e.g., "Apache 2.0", "Llama 2 Community License");

c) The source or provider of the Base Model (e.g., "Meta", "Hugging Face", "Mistral AI");

d) Any modifications or fine-tuning performed;

e) Any datasets used for training or fine-tuning, including their licenses;
...
a) **Breach of Warranties:** Your breach of any representation, warranty, or covenant in this Agreement;

b) **IP Infringement:** Any claim that Your Submitted Materials infringe, misappropriate, or otherwise violate any intellectual property right of any third party;

c) **License Violations:** Your violation of any third-party license terms applicable to Base Models or datasets;
...
a) Determining and paying all taxes, duties, and assessments associated with Your receipt of Rewards;

b) Reporting cryptocurrency income to applicable tax authorities;

c) Maintaining records of all Reward transactions;
...
- Modify the reward distribution schedule or mechanism with reasonable notice
...
c) You will receive any Rewards or any specific amount of Rewards;
...
- **Volatility:** TAO token value may fluctuate significantly
